...
{
 Intent turn=n =new Intent BlutoothAdapter.ACTION_REQUEST_ENABLE);
...
list.add(bt.getName());
Toast.makeText(getApplicationContext()."Showing PairedDevices",Toast.LENGTH_SHORT).show();
...
return suoper.onOptionsItemSelected(item);
