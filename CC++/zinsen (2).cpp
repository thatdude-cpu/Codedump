...

{
	...
	if(ver>1000)
	{
     printf("preis fuer 1 KWh:		 0.13 EUR + 0.03 EUR = 0.16 EUR\n");
	 printf("Mehrpreis ab 1000 Kwh:  0.03 EUR\n");
	 printf("Anschlussgebuehr:				       27.30 EUR\n");
	 veur=ver*0.13;
	 printf("Verbrauch:		  %6i *   0.03 EUR =        + %7.2lf EUR\n",ver,veur);
	 printf("					              ----------\n");
	}
	 else
	{
	...
	printf("Anschlussgebuehr:				       27.30 EUR\n");
	veur=ver*0.13;
	printf("Verbrauch:		  %6i *  0.13 EUR =        + %7.2lf EUR\n",ver,veur);
	printf("					              ----------\n");
	}
	zus=veur+27.30;
	printf("					             %7.2lf EUR\n",zus);
